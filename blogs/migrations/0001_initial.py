    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format=None, keep_meta=True, null=True, quality=85, scale=None, size=[800, 800], upload_to='blogs/', verbose_name='List Image')),
